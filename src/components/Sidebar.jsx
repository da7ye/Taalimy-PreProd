const NAV = [
  { section: "Overview",   items: [{ id: "home", label: "Dashboard", icon: IconHome }] },
  { section: "People",     items: [
    { id: "teachers",  label: "Teachers",  icon: IconGrad },
    { id: "students",  label: "Students",  icon: IconBook },
    { id: "parents",   label: "Parents",   icon: IconUsers },
  ]},
  { section: "Academics",  items: [
    { id: "matieres",    label: "Subjects",     icon: IconLayers },
    { id: "levels",      label: "Levels",       icon: IconTag },
    { id: "classes",     label: "Classes",      icon: IconSchool },
    { id: "assignments", label: "Assignments",  icon: IconClip },
    { id: "timetable",   label: "Timetable",    icon: IconCal },
    { id: "notes",       label: "Grades",       icon: IconNote },
  ]},
  { section: "Attendance", items: [{ id: "absences", label: "Absences", icon: IconAlert }] },
  { section: "Finance",    items: [{ id: "payments", label: "Payments", icon: IconPayment }] },
  { section: "Admin",      items: [{ id: "approve",  label: "Approve Users", icon: IconCheck }] },
];
      ...
      <div style={{ padding: "12px 14px 18px", borderTop: "1px solid var(--border)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "4px 8px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10.5, color: "var(--text-faint)" }}>Administrator</div>
          </div>
        </div>
      </div>
    </aside>
