  ...
  if (view === "list") return (
    <div className="page-enter" style={{ padding:"36px 44px" }}>
      <div style={{ display:"flex", alignItems:"flex-end", justifyContent:"space-between", marginBottom:28 }}>
        <PageTitle crumb={t("students.crumb")} title={t("students.title")}
      ...
      {loading
        ...
        : paginated.length === 0
          ? <div className="empty-state">
              ...
              {(q||filterClass||filterStatus) && <button onClick={resetFilters} className="btn-ghost" style={{ marginTop:8 }}>Clear filters</button>}
            </div>
          : <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(270px, 1fr))", gap:16 }}>
              {paginated.map((r,i)=>(
                <StudentCard key={r.id??i} r={r} t={t}
